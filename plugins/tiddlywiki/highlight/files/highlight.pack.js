...
}],illegal:/\S/}}})());hljs.registerLanguage("arduino",(()=>{"use strict";function e(e){
...
starts:{end:/[^\\]$/,subLanguage:"bash"}}],illegal:"</"})})());hljs.registerLanguage("matlab",(()=>{"use strict";return e=>{var a={relevance:0,
...
begin:'""'}],starts:a
},e.COMMENT("^\\s*%\\{\\s*$","^\\s*%\\}\\s*$"),e.COMMENT("%","$")]}}})());hljs.registerLanguage("perl",(()=>{"use strict";function e(...e){
...
begin:/>/,relevance:0}]}]}}})());hljs.registerLanguage("asciidoc",(()=>{"use strict";return e=>({name:"AsciiDoc",
...
className:"symbol",begin:/<[\w-]+>/}]})})());hljs.registerLanguage("erlang",(()=>{"use strict";return e=>{
...
name:"TypeScript",aliases:["ts"]}),b}})());hljs.registerLanguage("elixir",(()=>{"use strict";return e=>{
...
name:"Elixir",keywords:i,contains:t}}})());hljs.registerLanguage("clojure",(()=>{"use strict";return e=>{
...
illegal:/\S/,contains:[f,i,m,p,c,u,l,o,d]}}})());hljs.registerLanguage("http",(()=>{"use strict";return e=>{
...
end:"`",contains:[{begin:/\\./}]}]}}})());hljs.registerLanguage("ruby",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
})).join("")}return n=>{
var a,i="([a-zA-Z_]\\w*[!?=]?|[-+~]@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?)",s={
...
begin:"\\."+e.UNDERSCORE_IDENT_RE,relevance:0}]}}})());hljs.registerLanguage("vala",(()=>{"use strict";return e=>({name:"Vala",
keywords:{
...
className:"meta",begin:"^#",end:"$",relevance:2}]})})());hljs.registerLanguage("x86asm",(()=>{"use strict";return s=>({
...
className:"meta",begin:/^\s*\.[\w_-]+/}]})})());hljs.registerLanguage("autohotkey",(()=>{"use strict";return e=>{const a={
...
begin:"A_[a-zA-Z0-9]+"},{begin:",\\s*,"}]}}})());hljs.registerLanguage("cmake",(()=>{"use strict";return e=>({name:"CMake",
...
},e.HASH_COMMENT_MODE,e.QUOTE_STRING_MODE,e.NUMBER_MODE]})})());hljs.registerLanguage("python",(()=>{"use strict";return e=>{const n={
...
begin:/\(/,end:/\)/,keywords:n,illegal:/["']/}]}]}}})());hljs.registerLanguage("erlang-repl",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
...
relevance:0},{begin:"[A-Z][a-zA-Z0-9_']*",relevance:0}]})})());hljs.registerLanguage("awk",(()=>{"use strict";return e=>({name:"Awk",keywords:{
...
},e.REGEXP_MODE,e.HASH_COMMENT_MODE,e.NUMBER_MODE]})})());hljs.registerLanguage("css",(()=>{"use strict";return e=>{
...
},{begin:e.IDENT_RE+"::",keywords:{built_in:t}},{begin:"->"}]}}})());hljs.registerLanguage("markdown",(()=>{"use strict";function n(...n){
...
contains:a,keywords:e,illegal:"\\S"}}})());hljs.registerLanguage("profile",(()=>{"use strict";return e=>({
...
end:"\\)$",excludeBegin:!0,excludeEnd:!0,relevance:0}]})})());hljs.registerLanguage("powershell",(()=>{"use strict";return e=>{const n={
$pattern:/-?[A-z\.\-]+\b/,
...
},{className:"literal",begin:/(-)[\w\d]+/,relevance:0}]},m)}}})());hljs.registerLanguage("fortran",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
...
},i,e.QUOTE_STRING_MODE,e.APOS_STRING_MODE,r,e.CSS_NUMBER_MODE]}]}}})());hljs.registerLanguage("haskell",(()=>{"use strict";return e=>{const n={
...
begin:"^[_a-z][\\w']*"}),n,{begin:"->|<-"}]}}})());hljs.registerLanguage("shell",(()=>{"use strict";return s=>({
